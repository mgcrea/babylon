...
var _pluginsAngular = require("./plugins/angular");

var _pluginsAngular2 = _interopRequireDefault(_pluginsAngular);

_parser.plugins.flow = _pluginsFlow2["default"];
_parser.plugins.jsx = _pluginsJsx2["default"];
_parser.plugins.angular = _pluginsAngular2["default"];
